...
public class GlobalErrorHandling {
    ...
    public ResponseEntity<ApiResponse<?>> handleDuplicateInventory(DuplicateInventoryException ex) {
    ...
    public ResponseEntity<ApiResponse<?>> handleExcelSheets(ExcelExportException ex) {
